  ...
  <div class="modal-dialog">
   <div class="modal-content">
       <div class="modal-header">
        ...
        <form #loginFormData="ngForm"  class="myForm" (ngSubmit)="loginformSubmit(loginFormData)">
...
if(loginFormData.valid){
        //console.log('dataSubmitted',loginForsucesssmData.value);
      //console.log('loginformvalid',loginFormData.valid);
      this.api.loginAdmin(loginFormData.value).then((res:any)=>{
          console.log('res',res);
